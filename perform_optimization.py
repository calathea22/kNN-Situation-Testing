...
from simulate_data import simulate_explainable_discrimination_admission_data, simulate_non_explainable_discrimination_admission_data, simulate_train_test_and_val_with_discrimination, \
    simulate_non_explainable_discrimination_4_attributes_admission_data
from adult_data_preparing import load_adult_train_val_test_data, load_discriminated_adult_train_val_test_data
...
def perform_optimization(location, simulation_function, n, test_percentage, val_percentage, n_biased=0):
    ...
    train_data_dict, test_data_dict, val_data_dict = load_discriminated_adult_train_val_test_data(n, n_biased, test_percentage, val_percentage)
    ...
    possible_lambdas = np.arange(0.19, 0.02, -0.02)
