from giving_discrimination_scores import give_all_disc_scores_k_approach, give_disc_scores_one_technique, give_disc_scores_to_given_indices
...
def give_disc_scores_validation_set(location, indices_info, k_info, best_lambda_euclidean, best_lambda_mahalanobis):
    ...
    baseline_scores, luong_scores, zhang_scores, weighted_euclidean_scores, mahalanobis_scores = give_all_disc_scores_k_approach(
...
def make_diff_in_disc_scores_df(location, indices_info, k_info, best_lambda_euclidean, best_lambda_mahalanobis):
    ...
    utils.store_in_excel(dataframe_disc_scores, "C:/Users/daphn/PycharmProjects/kNN Situation Testing/adult_without_groundtruth_final/", "diff_in_disc_scores_test.xlsx")
