import utils
from zhang_algorithm import give_discrimination_scores_zhang
...
def zhang_preprocessing_admission_train(train_data, sens_attribute, decision_attribute, column_info):
    ...
    return train_data, bin_edges_dict, range_dict


def zhang_preprocessing_admissison_test(test_data, bin_edges_dict, sens_attribute, decision_attribute):
...
def get_zhang_discrimination_scores_admission(train_data, train_sens_attribute, train_decision_attribute, test_data, test_sens_attribute, test_decision_attribute, k):
    ...
    train_data, bin_edges_dict, range_dict = zhang_preprocessing_admission_train(train_data, train_sens_attribute, train_decision_attribute, column_info)
    test_data = zhang_preprocessing_admissison_test(test_data, bin_edges_dict, test_sens_attribute, test_decision_attribute)
    discrimination_scores = give_discrimination_scores_zhang('Gender', 'Admission', train_data, test_data, k, column_info, range_dict, 1, 2)
...
def get_zhang_discrimination_scores_adult(train_data, train_sens_attribute, train_decision_attribute, test_data, test_sens_attribute, test_decision_attribute, k):
    ...
    train_data, bin_edges_dict, range_dict = zhang_preprocessing_adult_train(train_data, train_sens_attribute,
    ...
    discrimination_scores = give_discrimination_scores_zhang('Gender', 'Income', train_data, test_data, k,
