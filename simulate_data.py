...
def add_discrimination_admission(data_dict, biased_percentage):
    ...
    print(number_of_positive_for_protected)
...
def split_data_dict(data_dict, discriminated_indices, n_samples_test, n_samples_val):
    ...
    print("___________")
    print(len(train_discriminated_indices))
    print(len(validation_discriminated_indices))
    print(len(test_discriminated_indices))
